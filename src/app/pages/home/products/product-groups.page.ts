            ...
            <ng-container ngbColumnDef="actions">
              ...
              <td *ngbCellDef="let productGroup" ngb-cell>
                <app-action-dropdown>
                  ...
                  <a class="d-flex gap-2 align-items-center" [routerLink]="'../' + productGroup.id" type="button" ngbDropdownItem>
...
export class ProductGroupsPage {
  ...
  delete = injectTableDelete({
    ...
    nameMap: mapName(),
    deleted: () => this.#productGroupsService.triggerGet$.next(true),
  });
