...
import {SystemNotificationTypeBadge} from '../../../components/system-notification-type-badge';
...
@Component({
          ...
          <table [hover]="true" [dataSource]="dataSource" ngb-table ngb-sort ngbSortActive="id" ngbSortDirection="asc">
            ...
            <ng-container ngbColumnDef="type">
              ...
              <td *ngbCellDef="let it" ngb-cell>
                <system-notification-type-badge [type]="it.type" />
              </td>
            </ng-container>
  ...
  `,
  selector: 'system-notifications-page',
