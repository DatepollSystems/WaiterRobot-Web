...
import {systemNotificationTypes} from '../services/system-notifications.service';
...
@Component({
  ...
  `,
  selector: 'system-notification-edit-form',
  imports: [
    ReactiveFormsModule,
    TranslocoPipe,
    BiComponent,
...
export class SystemNotificationEditForm extends AbstractModelEditFormComponent<
