...
import {SystemNotificationAlert} from './system-notification-alert';
...
@Component({
  ...
  `,
  selector: 'active-system-notifications',
  imports: [SystemNotificationAlert],
})
export class ActiveSystemNotifications {
...
@Component({
  ...
  `,
  selector: 'active-system-desktop-notifications',
  imports: [BiComponent, TranslocoPipe, ActiveSystemNotifications],
})
export class ActiveSystemNotificationsDesktop {
  activeSystemNotificationsService = inject(ActiveSystemNotificationsService);
}
...
@Component({
  ...
  `,
  selector: 'active-system-mobile-toggle-notifications',
  imports: [BiComponent, TranslocoPipe],
})
export class ActiveSystemNotificationsMobileToggle {
  activeSystemNotificationsService = inject(ActiveSystemNotificationsService);
}
