...
export const ROUTES: Routes = [
  {
    ...
    children: [
      {path: 'all', loadComponent: () => import('./all-tables.component').then((c) => c.AllTablesComponent)},
      {path: ':id', loadComponent: () => import('./table-edit/table-edit.component').then((c) => c.TableEditComponent)},
      {path: 'groups/all', loadComponent: () => import('./table-groups.component').then((c) => c.TableGroupsComponent)},
      {
        path: 'groups/create',
